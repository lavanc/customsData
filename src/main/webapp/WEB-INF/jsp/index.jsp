<%@ include file="common/header.jsp" %>
	...
	<div class="link">
		...
		<form:form modelAttribute="user" action="/sphb/create" method="post">
	...
	<c:forEach var="current" items="${users}">
		...
		<td><a href="/sphb/edit/${current.userName}">Edit</a></td>
		<td><a href="/sphb/delete/${current.userName}">Delete</a></td>
		</tr>
	</c:forEach>
	</table>
	</c:if>
...
<script type="text/javascript">
	...
	$(function() {
		$("#save").click(function(event) {
        	$("#user").attr("action", "/sphb/create")
			$("#user").submit();
		});

		$("#search").click(function(event) {
        	$("#user").attr("action", "/sphb/search")
			$("#user").submit();
